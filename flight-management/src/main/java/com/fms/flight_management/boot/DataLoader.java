package com.fms.flight_management.boot;
...
import com.fms.flight_management.domain.repo.PassengerRepository;
import com.fms.flight_management.domain.util.DateUtil;
