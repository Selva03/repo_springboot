package com.fms.flight_management.domain.entity;
...
public class FlightBooking {
	...
	@GenericGenerator(name = "booking-id-gen", parameters = @Parameter(name = "prefix", value = "FB"), strategy = "com.fms.flight_management.domain.util.StringSequenceIdGenerator")
	private String id;
